...
public class MyTests {
  ...
  public static void assertTrueString(
      boolean condition, String expected, String actual, String message) {
    if (condition) {
  ...
  public void testAsksForName() throws IOException {
    try (ByteArrayOutputStream bos = new ByteArrayOutputStream()) {
      ...
      assertTrue(
          output.length() > 50,
          "The output is too short. Add some more questions for your ChatBot.");
